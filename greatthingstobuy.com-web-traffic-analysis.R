...
googleCountryData <-read.table(file="C:/Users/Justin/Desktop/Datasets/Social Media Traffic Analysis/Amazon Fee Orders Data.csv", header=TRUE, skip = 1, sep=",")
#
#
googleNetworkReferrals <- read.table(file="C:/Users/Justin/Desktop/Datasets/Social Media Traffic Analysis/Google Network Referrals.csv", header=TRUE, sep=",")


# Display output Section


print(googleNetworkReferrals)
